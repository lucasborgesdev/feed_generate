...
exports.MakeXMLStringPinterest = void 0;
// Certifique-se de ajustar o caminho conforme necessário

const MakeXMLStringPinterest = async response => {
  console.log('ola');
  let products_list = "";
          ...
          for (let index_2 in product.childSKUs) {
            ...
            if (!product.excludeFromSitemap) {
              ...
              <item>
                  ...
                  <g:google_product_category>486</g:google_product_category>
                  <g:ean>0</g:ean>
                  <g:mpn>0</g:mpn>
                  <g:tax>
...
exports.MakeXMLStringPinterest = MakeXMLStringPinterest;